...
if os.environ.get("DJANGO_DEBUG", default=False) in [
    "True",
    "true",
    "1",
    True,
...
DATABASES = {
    ...
    """ postgres database config on heroku server """
    "heroku": dj_database_url.config(
        conn_max_age=600, default="postgres:///dtb"
    ),
}
...
if TELEGRAM_TOKEN is None:
    logging.error(
        ...
        "Example of .env file: https://github.com/sajadsj"
    )
    sys.exit(1)
